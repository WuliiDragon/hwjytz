...
public class Main {
    ...
    public static void main(String[] args) throws CloneNotSupportedException {
        ...
        List<List<VMHaveRequest>> vmHaveRequestListCurrent = Initialize.initVMRequest();
        ...
        Initialize.initialize(serverTypeList, vmTypeList, vmHaveRequestListCurrent);
        vmNum = 0;
        requestTotalDayNum = vmHaveRequestListCurrent.size();
        ...
        VmDeployStrategy1.vmDeployStrategy1(vmHaveRequestListCurrent, Initialize.vmIdMap, sinAndDouServerList, serverIdMap, serverTypeList, vmMigrationMap);
